/* Kth Smallest or Largest Element in O(n)
Statement: Given an array, find the Kth smallest or largest element in O(n) time complexity.
Approach
● QuickSelect Algorithm (variation of QuickSort)
● Selects a pivot and partitions the array around it.
● Recursively narrows down to the Kth element.
